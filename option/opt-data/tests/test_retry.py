...
class TestRetryWithBackoff:
    ...
    def test_sync_function_fails_after_max_attempts(self):
        ...
        @retry_with_backoff(
            max_attempts=3, initial_delay=0.01, retriable_exceptions=(ConnectionError,)
        )
        def test_func():
            return mock_func()
    ...
    def test_non_retriable_exception_fails_immediately(self):
        ...
        @retry_with_backoff(max_attempts=3, retriable_exceptions=(ConnectionError,))
        def test_func():
            return mock_func()
...
class TestRetryPolicy:
    ...
    async def test_async_execution_with_retry(self):
        ...
        policy = RetryPolicy(max_attempts=3, initial_delay=0.01, retriable_exceptions=(ValueError,))
